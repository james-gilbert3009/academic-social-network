...
export default function PostEngagementModal({
  ...
  const modal = (
    <div
      className="modalOverlay postEngagementModalOverlay"
      role="dialog"
      aria-modal="true"
      ...
      <div className={`modalCard postEngagementModal ${sizeClass}`}>
        ...
        <div className="postEngagementModal__tabs" role="tablist" aria-label="Engagement tabs">
          <button
            ...
            className={
              activeTab === "likes"
                ? "postEngagementModal__tab postEngagementModal__tab--active"
                : "postEngagementModal__tab"
            }
                  ...
                  <div className="postEngagementModal__commentRow" key={c._id}>
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      ...
                      >
                        ...
                        <RoleBadge role={u?.role} />
                        <span className="muted postEngagementModal__commentUsername">@{u.username || "user"}</span>
                      </button>
